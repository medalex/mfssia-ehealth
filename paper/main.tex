...
\node[pub] (pu2) at (4.5, 2.5)
  {\textit{allergyMatrix}\\[-2pt]
   \textit{adultMaxDosages}\\[-2pt]\textit{policyDrugIds}};
...
$\mathit{policyDrugIds}$, $\mathit{allergyMatrix}$,
...
\vec{x} = [&\,\underbrace{\mathit{XXX}}_{\mathit{stmtHash}},\;
           ...
           &\underbrace{[101,102,103,104]}_{\mathit{policyDrugIds}},\;
...
$\mathit{pub} = \langle \mathit{outcome}, \mathit{stmtHash}, \mathit{doctorCredentialHash},$\newline $\mathit{validCredentialRoot}, \mathit{nonce}, \mathit{policyDrugIds}, \mathit{allergyMatrix}, \mathit{adultMaxDosages} \rangle$ & Eq.~\ref{eq:public-inputs} & Public input vector for on-chain verification \\
